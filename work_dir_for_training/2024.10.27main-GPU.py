...
def main(args, data):
    ...
    # 定义训练数据
    selected_data = data.data_for_motion_planning[:args.num_train].to(device)
    ...
    # 假设最大成功率
    max_success_rate = 128
    max_collision_rate = 110
    ...
    # plt.show()
    filename = (
        f"/home/xps/peng_collision_RNN/Motion_intutive/work_dir_for_training/2024.10.27/"
        f"Training_Process_num_train{args.num_train}_"
        f"batch_size{args.batch_size}_learning_rate{args.learning_rate}_"
        f"_epochs{args.epochs}.png"
    )
